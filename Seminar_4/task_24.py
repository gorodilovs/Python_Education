...
for i in range(len(bushesRow)):
    if i == 0:
        if maxBerries < bushesRow[0] + bushesRow[1] + bushesRow[-1]:
            maxBerries = bushesRow[0] + bushesRow[1] + bushesRow[-1]  
    if i == len(bushesRow) - 1:
        if maxBerries < bushesRow[0] + bushesRow[-1] + bushesRow[-2]:
            maxBerries = bushesRow[0] + bushesRow[-1] + bushesRow[-2]
    if i != 0 and i != len(bushesRow) - 1:
        if maxBerries < bushesRow[i-1] + bushesRow[i] + bushesRow[i+1]:
            maxBerries = bushesRow[i-1] + bushesRow[i] + bushesRow[i+1]
