...
# userInput = "пара-ра-рам рам-пам-папам па-ра-па-дам"
...
#     vowels = re.findall("[А, О, У, Ы, Э, Е, Ё, И, Ю, Я]", phrase.upper())
#     vowelsList.append(len(vowels))
# print(vowelsList)

vowels = list(map(lambda x: re.findall("[А, О, У, Ы, Э, Е, Ё, И, Ю, Я]", x.upper()), phrases))
print(vowels)

matched = True
for item in vowels:
    if len(item) != len(vowels[0]):
        matched = False
if (matched):
    print("Парам пам-пам")
else:
